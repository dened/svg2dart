...
/// {@template Generated$SVG}
/// Generated$SVG widget.
/// {@endtemplate}
class Generated$SVG extends LeafRenderObjectWidget {
  /// {@macro Generated$SVG}
  const Generated$SVG({super.key, this.width, this.height, this.colorFilter});
  ...
  void updateRenderObject(
    ...
    Generated$SVGRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Generated$SVGRenderObject extends RenderBox {
  Generated$SVGRenderObject();

  final _painter = _Generated$SVGPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Generated$SVG.svgSize.width;
    final desiredHeight = _height ?? Generated$SVG.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Generated$SVG.svgSize.width == 0 || Generated$SVG.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / Generated$SVG.svgSize.width,
      size.height / Generated$SVG.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - Generated$SVG.svgSize.width * scale) / 2;
    final dy = (size.height - Generated$SVG.svgSize.height * scale) / 2;
