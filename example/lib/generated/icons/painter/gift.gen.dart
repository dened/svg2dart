...
/// Gift$SVG widget.
/// {@endtemplate}
class Gift$SVG extends StatelessWidget {
  /// {@macro Gift$SVG}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gift$SVGPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gift$SVGPainter}
/// Custom painter for [Gift$SVG].
/// {@endtemplate}
class Gift$SVGPainter extends CustomPainter {
  /// {@macro Gift$SVGPainter}
  const Gift$SVGPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gift$SVGPainter oldDelegate) =>
