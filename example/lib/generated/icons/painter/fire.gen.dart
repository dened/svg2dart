...
/// Fire$SVG widget.
/// {@endtemplate}
class Fire$SVG extends StatelessWidget {
  /// {@macro Fire$SVG}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Fire$SVGPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Fire$SVGPainter}
/// Custom painter for [Fire$SVG].
/// {@endtemplate}
class Fire$SVGPainter extends CustomPainter {
  /// {@macro Fire$SVGPainter}
  const Fire$SVGPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Fire$SVGPainter oldDelegate) =>
